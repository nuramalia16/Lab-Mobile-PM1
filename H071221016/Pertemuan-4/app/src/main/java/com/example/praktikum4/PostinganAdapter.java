...
public class PostinganAdapter extends RecyclerView.Adapter<PostinganAdapter.ViewHolder> {
    ...
    public PostinganAdapter(ArrayList<User> users) {
        this.users = users;
    }
    ...
    public void onBindViewHolder(@NonNull PostinganAdapter.ViewHolder holder, int position) {
        ...
        holder.tv_username.setText(user1.getUsername());
        holder.tv_name.setText(user1.getName());
        holder.ivProfile.setImageResource(user1.getFotoProfile());
        holder.ivFeed.setImageResource(user1.getFotoPostingan());
        holder.IVFeed.setImageURI(user1.getSelectedImageUri());
        holder.tv_caption.setText(user1.getDesc());
