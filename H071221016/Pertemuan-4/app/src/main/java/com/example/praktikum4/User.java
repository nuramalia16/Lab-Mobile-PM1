...
public class User implements Parcelable {
    ...
    public User(String username, String name, String desc, int fotoProfile, int fotoPostingan) {
    ...
    public User(String username, String name, String konten, int fotoProfile, Uri selectedImageUri) {
        this.username = username;
        this.name = name;
        this.desc = konten;
        this.fotoProfile = fotoProfile;
